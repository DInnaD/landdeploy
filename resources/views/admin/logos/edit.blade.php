...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit Logo: <b>{{$logo->name}}</b></div>
    ...
    <div class="panel-body">
        ...
        {!! Form::model($logo, ['route' => ['logos.update', $logo->id], 'method'=> 'PUT', 'enctype' => 'multipart/form-data', 'file'=>true]) !!}
        @include('admin.logos._form')
        @include('admin.logos._edit_form')
